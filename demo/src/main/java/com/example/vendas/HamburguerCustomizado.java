...
public class HamburguerCustomizado {
    ...
    public String toString() {
        return "Burger Custom: " + pao + ", " + proteina + (queijoExtra ? " + Queijo Extra" : "")
    ...
    public static class Builder {
        ...
        public Builder comQueijoExtra() {
            this.queijoExtra = true;
            return this;
        }

        public Builder comMolhoEspecial() {
            this.molhoEspecial = true;
            return this;
        }

        public HamburguerCustomizado build() {
            return new HamburguerCustomizado(this);
        }
    }
}
